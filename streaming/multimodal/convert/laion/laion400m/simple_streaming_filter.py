...
with streaming.MDSWriter(out="oci://mosaicml-internal-dataset-laion/filtered3", columns=columns, compression=None, hashes=[], size_limit=256*(2**20), max_workers=32) as writer:
